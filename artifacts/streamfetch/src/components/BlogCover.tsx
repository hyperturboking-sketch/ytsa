...
export default function BlogCover({
  ...
  const patternSvg = PATTERNS[pattern].replace(/id="p"/g, `id="${pid}"`).replace(/url\(#p\)/g, `url(#${pid})`);

  const isHero = size === "hero";

  return (
    <div
      className={`relative overflow-hidden w-full ${isHero ? "h-52 sm:h-72 md:h-80" : "aspect-[16/9]"} ${className}`}
      style={{
        background: `linear-gradient(135deg, var(--cover-from), var(--cover-to))`,
      }}
    >
      {/* Gradient layer via inline style */}
      <div
      ...
      <div
        ...
        style={{
          width: isHero ? 500 : 280,
          height: isHero ? 500 : 280,
          top: "50%",
          left: "50%",
          transform: "translate(-50%, -50%)",
          zIndex: 2,
      ...
      <div
        ...
        style={{
          width: isHero ? 700 : 380,
          height: isHero ? 700 : 380,
          top: "50%",
          left: "50%",
          transform: "translate(-50%, -50%)",
          zIndex: 2,
      ...
      <div
        ...
        style={{
          width: isHero ? 280 : 140,
          height: isHero ? 280 : 140,
          top: "50%",
          left: "50%",
          transform: "translate(-50%, -50%)",
          zIndex: 2,
