          ...
          <div className="md:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3 group mb-5">
              <div className="relative">
                <div className="absolute inset-0 bg-violet-500/30 rounded-2xl blur-xl group-hover:bg-violet-400/50 transition-all duration-500" />
                <img
                  src={`${import.meta.env.BASE_URL}logo.png`}
                  alt="YTSave"
                  className="relative w-12 h-12 object-contain drop-shadow-[0_0_16px_rgba(139,92,246,0.4)] group-hover:drop-shadow-[0_0_24px_rgba(139,92,246,0.7)] group-hover:scale-110 transition-all duration-300"
                />
              </div>
