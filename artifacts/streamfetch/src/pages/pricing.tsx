...
const cardVariants = {
  ...
  show: { opacity: 1, y: 0, scale: 1, filter: "blur(0px)", transition: { duration: 0.6, ease: [0.22, 1, 0.36, 1] as [number, number, number, number], type: "spring" as const, stiffness: 120, damping: 18 } },
};
