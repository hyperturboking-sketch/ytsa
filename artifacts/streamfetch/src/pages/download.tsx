...
const RELEASES = {
  windows: {
    ...
    ext: ".exe installer · run it and follow the wizard — no manual setup needed",
    badge: "Ready to run" as string | null,
    icon: Monitor,
    color: "from-blue-500 to-cyan-500",
    bg: "from-blue-500/10 to-cyan-500/10",
    border: "border-blue-500/30",
    url: "/downloads/YTSave-Setup.exe",
  },
  mac: {
    ...
    url: "/downloads/YTSave-macOS.dmg",
  },
  linux: {
    ...
    url: "/downloads/YTSave-Linux.AppImage",
  },
};
